        ...
        <footer id="footer">
            <div className="inner">
                <ul className="icons">
                    ...
                    <li><a target="_blank" href="https://www.instagram.com/_.ayushgupta/" className="icon brands fa-instagram"><span className="label">Instagram</span></a></li>
                    <li><a target="_blank" href="mailto:ayush.gupta.1197@gmail.com" className="icon solid fa-envelope"><span className="label">Email</span></a></li>
                </ul>
